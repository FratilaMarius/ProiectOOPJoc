...
void Labyrinth::GenerateRoom(int x, int y, int originX, int originY) {         // cand intram intr o camera noua daca e goala o generam
  if(layout[x][y].Id() == 0) {
    moves++;
...
void Labyrinth::Spawn(int x, int y) {               // functia de mai sus dar apelata la inceput
    layout[x][y].Id(1);
